<?php
/**
 * SchemaOrgBreadCrumbs JSON format
 */

// Exit if the file is called directy by URL.
defined( 'ABSPATH' ) || exit;

if ( ! class_exists('SchemaOrgBreadCrumbs') ) {
    ...
    class SchemaOrgBreadCrumbs {
        ...
        private static ?SchemaOrgBreadCrumbs $instance = null;
         ...
         */
        private mixed $show_on_front;

        /**
         * @var false|null|string
         */
        private mixed $page_for_posts;
